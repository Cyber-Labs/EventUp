...
function AboutUsBanner1(props){
  return(
    <div className="row m-0" >
      ...
      <div className="col-md-6 lightestBlueBackground p-5 text-white">
        {/* <h1 className="px-5 mx-5 heading1">EventUp</h1> */}
        <h2 className="px-5 mx-5 heading2">Organize Events Hastle Free</h2>
        <p className="px-5 mx-5 para1">EventUp is an open source initiative website where you can choose to attend an event (either physically or virtually) based on your interest .
          Get your attendance marked digitally by scanning a QR code.
        </p>
      </div>
      <div className="col-md-6 lightestBlueBackground p-5">
